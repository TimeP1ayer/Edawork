...
# Wed Jan 03 01:25:38 2024

# (NEW DESIGN)

# create a new design
new_design -name "hc138" -family "ProASIC3"
...
set_defvar "IDE_DESIGNERVIEW_ROOTDIR" {C:\EDA\cpu74hc138\designer}
set_defvar "IDE_DESIGNERVIEW_LASTREV" "1"

# set working directory
set_defvar "DESDIR" "C:/EDA/cpu74hc138/designer/impl1"

# set back-annotation output directory
set_defvar "BA_DIR" "C:/EDA/cpu74hc138/designer/impl1"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "hc138.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VERILOG" {../../synthesis/hc138.edn}

# save the design database
save_design {hc138.adb}
