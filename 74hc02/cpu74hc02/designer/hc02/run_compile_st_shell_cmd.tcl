...
save
set has_violations {C:\EDA\74hc02\cpu74hc02\designer\hc02\hc02_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {C:\EDA\74hc02\cpu74hc02\designer\hc02\hc02_combinational_loops.xml}
if { [catch "file delete -force -- {C:\EDA\74hc02\cpu74hc02\designer\hc02\pinslacks.txt}"] } {
   ;
}
report -type slack {C:\EDA\74hc02\cpu74hc02\designer\hc02\pinslacks.txt}
