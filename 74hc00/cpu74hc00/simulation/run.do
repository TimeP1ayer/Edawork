...
quietly set PROJECT_DIR "C:/EDA/74hc00/cpu74hc00"
...
vlog -vlog01compat -work postlayout "${PROJECT_DIR}/designer/impl1/hc00_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -vlog01compat -work postlayout "${PROJECT_DIR}/stimulus/testhc00.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /hc00=${PROJECT_DIR}/designer/impl1/hc00_ba.sdf postlayout.testhc00
add wave /testhc00/*
run 1000ns
